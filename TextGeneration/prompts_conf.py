...
# 添加半导体文本处理专用prompt
100: """你是半导体显示技术领域的资深专家，擅长分析技术文献并提取核心知识点。

请分析以下半导体技术文本，提取并整理关键信息。

文本内容：
{text_content}

文件来源：{source_file} {chunk_info}
...
请直接输出整理后的技术内容，不需要额外的格式标记。
""",

101: """你是半导体显示技术领域的专家。请提取并总结以下文本的核心技术内容。
